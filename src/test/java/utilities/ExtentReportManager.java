...
public class ExtentReportManager implements ITestListener {
	...
	/*	SimpleDateFormat df = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss");
		...
		sparkReporter.config().setDocumentTitle("OpenCartAutomation Report"); // Title of the Report
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			String imgPath = bc.captureScreen(result.getTestClass().getName());
...
/*		// Create Email Message 
		...
		try {
			...
			email.setAuthenticator(new DefaultAuthenticator("Jenifer@gmail.com","--"));
